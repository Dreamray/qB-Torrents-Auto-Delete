 ...
 * 根据最近一段时间内种子的平均上传速度删种，可避免一开始上传很快最后很慢，计算整个活动时间内的平均上传速度依然很快而不删的情况
...
5. 把代码内第7行 “// @match        http://localhost:60009/*” 内的IP和端口改成你自己qb webui的IP和端口
6. 修改代码的 设置部分，改成你想要的设置
7. 根据自己情况分别修改代码的 hrTrackerHourRatio、shuaPathList、keepCategoryList、qbittorrent 部分
